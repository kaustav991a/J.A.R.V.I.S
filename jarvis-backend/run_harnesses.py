...
# Kept as the historical record of what the list held when it was last
# reviewed, so a discovery bug shows up as a DIFFERENCE rather than as a quiet
# shrink. Re-stamped 2026-08-29: it still read 2026-08-08, and fifty-five
# harnesses had been "discovered since" - a diff that long is not a signal, it
# is a wall of text nobody reads, which is the failure mode this list exists to
# avoid. Every earlier baseline is in git history.
_KNOWN_AT_LAST_EDIT = [
    "test_action_parser.py",
    "test_admin_override.py",
    "test_agent_core.py",
    "test_agent_errors.py",
    "test_agent_files.py",
    "test_agent_governed.py",
    ...
    "test_briefing_sources.py",
    "test_briefing_truthfulness.py",
    "test_calibrate_gesture.py",
    "test_camera_stream.py",
    "test_chroma_crypto.py",
    "test_claims_guard.py",
    "test_commute_briefing.py",
    "test_confirm_path.py",
    "test_conversational_truthfulness.py",
    "test_cursor_overlay.py",
    "test_distance_question.py",
    "test_enroll_face.py",
    "test_face_gate.py",
    ...
    "test_hud_assets.py",
    "test_identity_challenge.py",
    "test_intent_fallback.py",
    "test_listen_request.py",
    "test_live_gate_session2.py",
    "test_live_gate_session4.py",
    "test_llm_failover.py",
    "test_lockdown_exits.py",
    ...
    "test_reference_compliance.py",
    "test_review_batch1.py",
    "test_review_batch1_medium.py",
    "test_review_batch2.py",
    "test_review_batch2_medium.py",
    "test_review_batch3.py",
    "test_review_batch4.py",
    "test_review_batch5.py",
    "test_romanise_nudge.py",
    "test_shared_memory.py",
    "test_shelf_preload.py",
    "test_shell_safety.py",
    "test_single_source.py",
    "test_speaker_errors.py",
    "test_state_durable.py",
    "test_store_paths.py",
    "test_store_retirement.py",
    "test_tool_call.py",
    "test_tracker_html.py",
    "test_truncated_actions.py",
    "test_url_precondition.py",
    "test_vision_markers.py",
    "test_voice_loop_owner.py",
